const customsFields = [
  ...
  },
  {
    ...
    name: 'fxRateGoods',
    hint: 'Курс для расчёта стоимости товара и международной доставки.',
    unit: '₪'
  },
  {
    label: 'Курс USD для налоговой базы',
    name: 'fxRateTax',
    hint: 'Курс таможни/налоговой базы (может отличаться от коммерческого).',
    unit: '₪'
  },
  {
    label: 'Аграт מחשב',
    name: 'computerFee',
    hint: 'Фиксированный сбор.',
    unit: '₪'
  },
  {
    label: 'Аграт ביטחון',
    name: 'securityFee',
    hint: 'Фиксированный сбор безопасности.',
    unit: '₪'
  },
  {
    label: 'Локальная логистика / шחרור',
    name: 'localLogistics',
    hint: 'Портовые и экспедиторские расходы на месте.',
    unit: '₪'
  },
  {
    label: 'Локальная доставка',
    name: 'inlandDelivery',
    hint: 'Доставка по стране назначения.',
    unit: '₪'
  },
  {
...
export default function CustomsPanel({ values, onChange }) {
  return (
    <section className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 md:p-8">
      <h3 className="text-lg font-semibold">Таможенные платежи (модель таблицы)</h3>
